  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", background: "#f8fafc", padding: "24px 20px 32px" }}>
      ...
      <div style={{ marginTop: 8, marginBottom: 20 }}>
        <div style={{ fontSize: 11, color: "#122A5C", fontWeight: 700, marginBottom: 6 }}>촬영 전 준비</div>
        ...
        {[{ v: "left", l: "왼손" }, { v: "right", l: "오른손" }].map((opt) => (
          <button
            ...
            style={{
              ...
              border: handSide === opt.v ? "2px solid #122A5C" : "1px solid #e2e8f0",
              background: handSide === opt.v ? "#EEF1F8" : "white",
              color: handSide === opt.v ? "#122A5C" : "#334155",
            }}
          >
            {opt.l}
          </button>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          {CHECKLIST.map((item) => (
            <div key={item} style={{ display: "flex", alignItems: "flex-start", gap: 8 }}>
              <Check style={{ width: 15, height: 15, color: "#122A5C", marginTop: 2, flexShrink: 0 }} />
      ...
      <div style={{ marginTop: 20, background: "#EEF1F8", border: "1px solid #B9C7E1", borderRadius: 14, padding: 14 }}>
        <p style={{ fontSize: 12, color: "#122A5C", lineHeight: 1.6, margin: 0 }}>
      ...
      <button
        ...
        disabled={!handSide}
        style={{ marginTop: 24, width: "100%", minHeight: 48, background: handSide ? "#122A5C" : "#cbd5e1", color: "white", border: "none", borderRadius: 12, fontSize: 15, fontWeight: 800 }}
      >
        촬영 시작하기
      </button>
    </div>
