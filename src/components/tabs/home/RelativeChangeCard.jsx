...
function RelativeChangeCard({ scans }) {
  ...
  const tone = status === "stable" ? "info" : "warning";
  const textClass = status === "worsening" ? "text-amber-800" : status === "insufficient" ? "text-amber-700" : "text-blue-800";

  return (
    <JTCard tone={tone} padding="p-3.5" className={textClass}>
